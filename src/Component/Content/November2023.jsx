function November2023() {
  return (
    <>
      <div id="content" class="relative lg:ml-20">
        <div class="">
          <div class="text-title text-2xl font-bold space-y-5 text-green-500">
            v2.7.10 (android) <span className="dateStyle">15 Nov 2023</span>
          </div>
          <div class="text-title text-2xl font-bold space-y-5 text-green-500">
            v1.6.7 (iPhone) <span className="dateStyle"> 15 Nov 2023</span>
          </div>
        </div>
        ...
        <div class="pt-5">
          ...
          <div class="text-title text-2xl font-bold space-y-5 text-green-500">
            v1.6.8 (iPhone) <span className="dateStyle"> 21 Nov 2023</span>
          </div>
        </div>
        <div class="text-2xl font-bold mx-2 my-2">Bug Fixes:</div>
        <ul class="list-disc px-20">
